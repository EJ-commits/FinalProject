...
$(document).ready(function(){
	...
	stomp.connect({},function(){
		...
		if(alArray[0]!='noPlantsWantWater'){
			$(".dropdown").eq(0).find("#plantAlarm").html("물이 먹고 싶어요.")
			...
			$(".dropdown").eq(0).find("#alarm1").html(alArray[1])
		})
	...
	<div id="header-box">
		...
		<div class="header-menu-box dropdown" >
			...
			<ul class="dropdown-menu" role="menu" style="width: 15em">
				<li><div class="dropdown-item" id="plantAlarm" style="text-align: center;" ></div></li>
				<li><div style="text-align: center; width: inherit;">
